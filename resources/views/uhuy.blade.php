...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!-- ===============================================-->
    <!--    Favicons-->
<link rel="apple-touch-icon" sizes="180x180" href="{{ asset('uhuy/public/assets/img/favicons/apple-touch-icon.png') }}">
<link rel="icon" type="image/png" sizes="32x32" href="{{ asset('uhuy/public/assets/img/favicons/favicon-32x32.png') }}">
<link rel="icon" type="image/png" sizes="16x16" href="{{ asset('uhuy/public/assets/img/favicons/favicon-16x16.png') }}">
<link rel="shortcut icon" type="image/x-icon" href="{{ asset('uhuy/public/assets/img/favicons/favicon.ico') }}">
<link rel="manifest" href="{{ asset('uhuy/public/assets/img/favicons/manifest.json') }}">
<meta name="msapplication-TileImage" content="{{ asset('uhuy/public/assets/img/favicons/mstile-150x150.png') }}">
    ...
    <!--    Stylesheets-->
    <!-- ===============================================-->
    <link href="{{asset('uhuy/public/assets/css/theme.css')}}" rel="stylesheet" />
  ...
  <body>
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3 d-block" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand" href="index.html"><img class="d-inline-block" src="{{asset('uhuy/public/assets/img/gallery/logo.png')}}" width="50" alt="logo" /><span class="fw-bold text-primary ms-2">voyage</span></a>
      ...
      <section class="mt-7 py-0">
        <div class="bg-holder w-50 bg-right d-none d-lg-block" style="background-image:url(uhuy/public/assets/img/gallery/viewnight.jpg);">
        </div>
        <!--/.bg-holder-->
...
{{-- 
      ...
      <section class="py-7 overflow-hidden">
        <div class="container bg-offcanvas-gray">
          <div class="row gx-2">
            ...
            <div class="col-sm-6 col-lg-4 gy-2">
              <div class="card card-span h-100 text-white"><img class="img-fluid h-100 w-100" src="{{asset('assets/img/gallery/queens-gambit.png')}}" height="375" alt="..." />
                <div class="card-img-overlay ps-0 d-flex flex-column justify-content-between bg-voyage-gradient">
                  <div class="mt-auto px-4">
            ...
            <div class="col-sm-6 col-lg-4 gy-2">
              <div class="card card-span h-100 text-white"><img class="img-fluid h-100 w-100" src="{{asset('assets/img/gallery/canals.png')}}" height="375" alt="..." />
                <div class="card-img-overlay ps-0 d-flex flex-column justify-content-between bg-voyage-gradient">
                  <div class="mt-auto px-4">
            ...
            <div class="col-sm-6 col-lg-4 gy-2">
              <div class="card card-span h-100 text-white"><img class="img-fluid h-100 w-100" src="{{asset('assets/img/gallery/mountain-venture.png')}}" height="375" alt="..." />
                <div class="card-img-overlay ps-0 d-flex flex-column justify-content-between bg-voyage-gradient">
                  <div class="mt-auto px-4">
      ...
      <section class="py-7" id="activities">
        ...
        <div class="container">
          <div class="row g-0">
            <div class="col-lg-4 order-1"><img class="w-100 mt-5 mt-lg-0" src="{{asset('assets/img/gallery/bungee-jumping.png')}}" height="750" alt="..." /></div>
            <div class="col-lg-8">
              <div class="carousel slide" id="carouselActivity" data-bs-ride="carousel">
                <div class="carousel-inner">
                  <div class="carousel-item active" data-bs-interval="10000">
                    <div class="row h-100">
                    <div class="col-12"><img class="w-100" src="{{asset('assets/img/gallery/activity.png')}}" width="383" alt="..." />
                        <div class="py-4">
        ...
        <div class="container bg-offcanvas-gray-right">
          <div class="row gx-2">
            <div class="col-sm-6 col-lg-4">
              <div class="bg-primary-gradient h-100 d-flex align-items-end">
                <div class="row g-0 justify-content-start">
                  <div class="col-xl-9">
                    <div class="p-3 px-lg-4 text-light"><img class="mb-5" src="{{asset('assets/img/icons/icon-hotel.svg')}}" alt="..." />
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="row g-2">
                <div class="col-12">
                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100 w-100" src="{{asset('assets/img/gallery/moon-house-hotel.png')}}" height="375" alt="..." />
                    <div class="card-img-overlay ps-0 d-flex flex-column justify-content-between bg-voyage-gradient">
                      <div class="mt-auto px-4">
                ...
                <div class="col-12">
                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100 w-100" src="{{asset('assets/img/gallery/blue-mosque-hotel.png')}}" height="375" alt="..." />
                    <div class="card-img-overlay ps-0 d-flex flex-column justify-content-between bg-voyage-gradient">
                      <div class="mt-auto px-4">
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="row g-2">
                <div class="col-12">
                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100 w-100" src="{{asset('assets/img/gallery/hotel-royal.png')}}" height="375" alt="..." />
                    <div class="card-img-overlay ps-0 d-flex flex-column justify-content-between bg-voyage-gradient">
                      <div class="mt-auto px-4">
                ...
                <div class="col-12">
                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100 w-100" src="{{asset('assets/img/gallery/boutique-hotel.png')}}" height="375" alt="..." />
                    <div class="card-img-overlay ps-0 d-flex flex-column justify-content-between bg-voyage-gradient">
                      <div class="mt-auto px-4">
        ...
        <div class="container-fluid container-lg">
          <div class="row h-100 g-2 justify-content-center">
            <div class="col-sm-9 col-md-4 mb-3 mb-md-0 h-100">
              <div class="card card-span text-white h-100"><img class="img-card h-100" src="{{asset('assets/img/gallery/blog-1.png')}}" alt="..." />
                <div class="card-body px-xl-5 px-md-3 pt-0 pb-7">
                  <div class="d-flex justify-content-between align-items-center bg-100 mt-n5 me-auto"><img src="{{asset('assets/img/gallery/author-1.png')}}" width="60" alt="..." />
            ...
            <div class="col-sm-9 col-md-4 mb-3 mb-md-0 h-100">
              <div class="card card-span text-white h-100"><img class="img-card h-100" src="{{asset('assets/img/gallery/blog-2.png')}}" alt="..." />
                <div class="card-body px-xl-5 px-md-3 pt-0 pb-7">
                  <div class="d-flex justify-content-between align-items-center bg-100 mt-n5 me-auto"><img src="{{asset('assets/img/gallery/author-2.png')}}" width="60" alt="..." />
            ...
            <div class="col-sm-9 col-md-4 mb-3 mb-md-0 h-100">
              <div class="card card-span text-white h-100"><img class="img-card h-100" src="{{asset('assets/img/gallery/blog-3.png')}}" alt="..." />
                <div class="card-body px-xl-5 px-md-3 pt-0 pb-7">
      ...
      <section>
        ...
        <div class="container">
          <div class="row flex-center">
            <div class="col-lg-6 text-center"><img class="mb-5 mb-lg-0" src="{{asset('assets/img/gallery/cta-mobile.png')}}" alt="..." /></div>
            <div class="col-lg-6 text-center">
              <h1 class="fs-6 pe-xxl-10">Get the app</h1>
              <div class="mt-4 pe-xxl-10"><a href="https://play.google.com/store/apps" target="_blank"><img class="me-3" src="{{asset('assets/img/gallery/google-play.png')}}" width="170" alt="..." /></a><a href="https://www.apple.com/app-store/" target="_blank"> <img src="assets/img/gallery/app-store.png" width="170" alt="..." /></a></div>
            </div>
          </div>
        </div>
      </section>
    ...
    <!--    JavaScripts-->
    <!-- ===============================================-->
    <script src="{{ asset('uhuy/vendors/@popperjs/popper.min.js') }}"></script>
    <script src="{{ asset('uhuy/vendors/bootstrap/bootstrap.min.js') }}"></script>
    <script src="{{ asset('uhuy/vendors/is/is.min.js') }}"></script>
    <script src="https://polyfill.io/v3/polyfill.min.js?features=window.scroll"></script>
    <script src="{{ asset('uhuy/vendors/fontawesome/all.min.js') }}"></script>
    <script src="{{ asset('uhuy/public/assets/js/theme.js') }}"></script>
